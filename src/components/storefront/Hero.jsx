      ...
      <div className="container relative z-20 mx-auto px-4 py-24 md:py-32">
        <div className="max-w-2xl">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-10 leading-relaxed max-w-xl">
            A headless commerce architecture. Manage your physical point of sale
            and e-commerce storefront from a single, secure Django backend.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              ...
              size="lg"
              className="bg-slate-900 dark:bg-blue-600 text-white hover:bg-slate-800 dark:hover:bg-blue-700 h-12 px-8 text-base border-none shadow-lg"
            >
              Browse Storefront
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="border-gray-300 dark:border-slate-700 dark:text-slate-200 dark:bg-slate-900/50 dark:hover:bg-slate-800 h-12 px-8 text-base gap-2 group backdrop-blur-sm shadow-sm"
            >
              Launch POS Terminal
